...
function change(event) {
    ...
    } else if (src.includes('bg_two.jpg')) {
        img.src = src;
    ...
    } else if (src.includes('bg_three.jpg')) {
        img.src = src;
    ...
    } else if (src.includes('bg_four.jpg')) {
        img.src = src;
    ...
    } else if (src.includes('bg_five.jpg')) {
        img.src = src;
    ...
    } else if (src.includes('bg_six.jpg')) {
        img.src = src;
